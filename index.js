...
const { createCuratedLists, updateCuratedLists, searchMovies, createWatchlist, createWishlist } = require('./controllers/movieControllers')
...
app.post('/api/movies/curated-list', )
